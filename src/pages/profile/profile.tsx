...
import ProfileDialog, { type ProfileFormValue } from "../../features/profile/dialog/ProfileDialog";
import AboutDialog from "../../features/profile/dialog/AboutDialog";
import EducateDialog, { type EducationItem } from "../../features/profile/dialog/EducateDialog";
import WorkexpDialog, { type WorkExperienceItem } from "../../features/profile/dialog/WorkexpDialog";
import ProjectDialog, { type ProjectItem } from "../../features/profile/dialog/ProjectDialog";
...
const DEFAULT_EDUCATION: EducationItem[] = Array.from({ length: 3 }).map((_, i) => ({
    id: i,
    school: "School Name",
...
const DEFAULT_WORK_EXPERIENCE: WorkExperienceItem[] = Array.from({ length: 3 }).map((_, i) => ({
    id: i,
    position: "Position",
    company: "Company",
    workType: "",
...
const DEFAULT_PROJECTS: ProjectItem[] = Array.from({ length: 2 }).map((_, i) => ({
    id: i,
    name: "Project Name",
...
export default function Profile() {
    ...
    const [workExperience, setWorkExperience] = useState<WorkExperienceItem[]>(DEFAULT_WORK_EXPERIENCE);
    const [projects, setProjects] = useState<ProjectItem[]>(DEFAULT_PROJECTS);
    const [profileForm, setProfileForm] = useState<ProfileFormValue>(DEFAULT_PROFILE_FORM);
        ...
        <div className="relative mx-auto mt-18 w-full max-w-[1411px] overflow-hidden rounded-[20px] bg-slate-100 aspect-[1411/275]">
            ...
            <div className="relative px-6 pb-6 pt-0">
                ...
                <div className="flex-1 md:mt-3">
                    ...
                    <h2 className="text-lg font-semibold text-slate-900">
                        {`${profileForm.firstName} ${profileForm.lastName}`.trim() || "Your Name"}
                    </h2>
                    <button
                        type="button"
            ...
            {editingImage && editingTarget ? (
                <ImageEditor
                    ...
                    image={editingImage}
                    outputSize={
                        editingTarget === "banner" ? { w: 1411, h: 275 } : { w: 320, h: 320 }
                    }
            ...
            {projectPreviewOpen && previewProject ? (
                <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 p-4">
                    <div className="w-full max-w-4xl rounded-3xl bg-white p-5 shadow-xl">
                        ...
                        <div>
                            <h3 className="mb-2 text-base font-medium text-slate-900">Skill use</h3>
