...
const preSkillCatalog: SkillCatalogItem[] = [
  {
    name: "JavaScript (ES6+)",
    description:
      "Core JavaScript syntax and modern ES6+ features for application development.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Basic static typing concepts used to build safer JavaScript applications.",
    preSkills: [],
    categories: ["Language", "Foundation"],
  },
  {
    ...
    description:
      "Design UI as reusable and composable components with clear responsibilities.",
    preSkills: [],
  ...
  },
  {
    name: "HTML5",
    description:
      "Semantic markup structure for modern web pages and accessible content.",
    preSkills: [],
  ...
  },
  {
    name: "CSS3",
    description:
      "Styling and layout techniques for responsive and modern interfaces.",
    preSkills: [],
    categories: ["Web", "Foundation"],
  },
  {
    ...
    description:
      "Build interfaces that adapt correctly across mobile, tablet, and desktop.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Asynchronous control flow with promises and async/await in JavaScript.",
    preSkills: [],
  ...
  },
  {
    name: "NPM Ecosystem",
    description:
      "Package management and dependency workflow in the Node.js ecosystem.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Design resource-oriented APIs with clear contracts and status handling.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Request pipeline processing pattern commonly used in server frameworks.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Methods, status codes, headers, and request-response lifecycle basics.",
    preSkills: [],
    categories: ["Web", "Foundation"],
  },
  {
  ...
  },
  {
    name: "Data Modeling",
    description:
      "Structuring entities and relationships for efficient data usage.",
    preSkills: [],
    categories: ["Database", "Data"],
  },
  {
    name: "JOIN Concepts",
    description:
      "Combining data across multiple tables using SQL join operations.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Schema strategy and document structure design for NoSQL systems.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Index strategies to improve query performance and lookup speed.",
    preSkills: [],
  ...
  },
  {
    name: "Self-awareness",
    description:
      "Recognizing personal strengths, limits, and communication impact.",
    preSkills: [],
  ...
  },
  {
    ...
    description:
      "Workplace behavior and communication standards for professional settings.",
    preSkills: [],
    categories: ["Soft Skill", "Professional"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Communicate using verifiable information and clear reasoning.",
    preSkills: [],
    categories: ["Soft Skill", "Professional"],
  },
  {
    ...
    description:
      "Build trust through reliable delivery and responsible communication.",
    preSkills: [],
    categories: ["Soft Skill", "Professional"],
  },
];
