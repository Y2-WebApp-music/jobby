    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex flex-1 min-h-0 gap-4 overflow-hidden px-6">
          {resume && d ? (
            <>
              <div className="flex min-h-0 w-[55%] min-w-0 flex-col overflow-hidden rounded-xl bg-white">
                <Tabs
                  defaultValue="basic"
                  className="flex min-h-0 flex-1 flex-col overflow-hidden"
                >
                  <div className="shrink-0 rounded-xl border border-neutral-200 bg-white p-[3px]">
                    <TabsList className="h-9 w-full justify-start rounded-xl bg-neutral-50">
                  ...
                  <div className="flex-1 min-h-0 rounded-xl border border-neutral-200 p-3">
                    <TabsContent
                      value="basic"
                          ...
                          <p className="text-sm">
                            {d.address?.address_line ||
                              [
                                ...
                                d.address?.soi,
                                d.address?.street,
                                d.address?.sub_district_th ||
                                  d.address?.sub_district,
                                d.address?.district_th || d.address?.district,
                                d.address?.province_th || d.address?.province,
                                d.address?.country_th || d.address?.country,
                              ]
                                .filter(Boolean)
                                .join(", ") ||
                              "—"}
            ...
            <div className="flex min-h-[360px] flex-1 items-center justify-center rounded-xl border border-neutral-200 bg-neutral-50 text-sm text-muted-foreground">
              {loading ? "Loading resume..." : "Resume detail unavailable."}
            </div>
          )}
        </div>
