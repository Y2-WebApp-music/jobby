...
export default function ProfileDialog({ open, onClose, onSave, initialData }: ProfileDialogProps) {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="mt-1 grid grid-cols-1 gap-2 sm:grid-cols-[84px_144px_minmax(0,1fr)]">
                            <div>
                                <label className="mb-1 block text-sm text-slate-700">Region</label>
                                <select
                            ...
                            <div>
                                <label className="mb-1 block text-sm text-slate-700">Tel.</label>
                    ...
                    <div className="space-y-2">
                        {formValue.links.map((item) => (
                            <div key={item.id} className="grid grid-cols-[minmax(0,130px)_minmax(0,1fr)_44px] gap-2">
                                <div>
                                ...
                                <div>
                                    <label className="mb-1 block text-sm text-slate-700">Link</label>
                                    <input
                                        value={item.url}
