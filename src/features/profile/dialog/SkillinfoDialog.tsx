...
export default function SkillinfoDialog({
    ...
    return (
        ...
        <div className="w-full max-w-[620px] rounded-[28px] bg-white p-4 shadow-xl sm:p-5">
            ...
            <div>
                <h3 className="text-[18px] leading-none font-semibold text-[#0A0A0A]">Category</h3>
            ...
            <div>
                <h3 className="text-[18px] leading-none font-semibold text-[#0A0A0A]">Pre-Skill</h3>
            ...
            <div>
                <h3 className="text-[18px] leading-none font-semibold text-[#0A0A0A]">Skill Description</h3>
